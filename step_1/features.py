...
if __name__ == "__main__":
    ...
    '''
    type_energie = []
    for col in ['type_energie_principale_chauffage','type_energie_n_1','type_energie_n_2','type_energie_n_3']:
    ...
    '''
    type_usage = []
    for col in ['type_usage_energie_n_1','type_usage_energie_n_2','type_usage_energie_n_3']:
